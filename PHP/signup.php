...
<body>
  ...
  <!-- title of website -->
  <div class="Site-Title"><a href="../index.html" class="Text">ThetaTravel</a></div>
      ...
      if ($password === $cpassword) {
        ...
        if ($result->num_rows > 0) {
          while($row = $result->fetch_assoc()) {
            $id = $row['user_id'];
            $sql = "INSERT into notifications(user_id, notification) VALUES('$id', 'Welcome to ThetaTravel')";
            $res = $conn->query($sql);
          }
        }
